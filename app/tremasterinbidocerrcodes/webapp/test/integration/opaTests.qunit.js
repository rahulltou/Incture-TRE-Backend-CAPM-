...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/inc/tremasterinbidocerrcodes/test/integration/FirstJourney",
    "com/inc/tremasterinbidocerrcodes/test/integration/ErrorCodesListJourney",
    "com/inc/tremasterinbidocerrcodes/test/integration/ErrorCodesObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
