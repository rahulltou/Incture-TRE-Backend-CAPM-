...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "com/inc/tremasterscheduler/test/integration/FirstJourney",
    "com/inc/tremasterscheduler/test/integration/SchedulerConfigListJourney",
    "com/inc/tremasterscheduler/test/integration/SchedulerConfigObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
